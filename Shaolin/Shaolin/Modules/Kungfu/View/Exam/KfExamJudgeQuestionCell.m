...
- (void) resetButton {
    [self.chooseTrueBtn setTitleColor:KTextGray_333 forState:UIControlStateNormal];
    [self.chooseFalseBtn setTitleColor:KTextGray_333 forState:UIControlStateNormal];
