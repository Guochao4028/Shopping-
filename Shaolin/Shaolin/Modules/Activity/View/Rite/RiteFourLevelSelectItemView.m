...
- (void)createCheckBoxView{
    ...
    self.checkBoxView = [[WJMCheckBoxView alloc] initCheckboxBtnBtns:checkBoxBtnArray config:[WJMTagViewConfig defaultConfig]];
...
- (UIView *)textFieldBackView{
    if (!_textFieldBackView){
        ...
        _textFieldBackView.backgroundColor = KTextGray_EEE;
...
- (UIButton *)confirmButton {
    if (!_confirmButton){
        ...
        _confirmButton.titleLabel.font = kRegular(15);
