...
- (UILabelLeftTopAlign *)titleLL
{
    if (!_titleLL) {
        ...
        _titleLL.textColor = KTextGray_333;
        _titleLL.text = @"";
    }
    return _titleLL;
}
...
//        _typeNumTf.delegate = self;
        ...
        [_typeNumTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UIImageView *)taxImage {
    if (!_taxImage) {
        _taxImage = [[UIImageView alloc]initWithFrame:CGRectMake(SLChange(127), SLChange(15), SLChange(120), SLChange(120))];
        _taxImage.image = [UIImage imageNamed:@"tax_box"];
        _taxImage.userInteractionEnabled = YES;
        _taxImage.contentMode = UIViewContentModeScaleAspectFill;
    }
    return _taxImage;
}
- (UIImageView *)taxCameraImage {
    if (!_taxCameraImage) {
        _taxCameraImage = [[UIImageView alloc]initWithFrame:CGRectMake(SLChange(46.5), SLChange(49), SLChange(27), SLChange(22))];
...
- (UIImageView *)qualificationImage {
    if (!_qualificationImage) {
        ...
        _qualificationImage = [[UIImageView alloc]initWithFrame:CGRectMake(SLChange(127), SLChange(15), SLChange(120), SLChange(120))];
...
- (UIImageView *)qualificationCameraImage {
    if (!_qualificationCameraImage) {
        _qualificationCameraImage = [[UIImageView alloc]initWithFrame:CGRectMake(SLChange(46.5), SLChange(49), SLChange(27), SLChange(22))];
...
- (UILabel *)typeLabel {
    if (!_typeLabel) {
        ...
        _typeLabel.textColor = KTextGray_999;
...
- (UILabel *)qualificationLabel {
    if (!_qualificationLabel) {
        _qualificationLabel = [[UILabel alloc]initWithFrame:CGRectMake(SLChange(98), SLChange(150), kWidth-SLChange(109), SLChange(41))];
        _qualificationLabel.font = kRegular(14);
        _qualificationLabel.textColor = KTextGray_999;
