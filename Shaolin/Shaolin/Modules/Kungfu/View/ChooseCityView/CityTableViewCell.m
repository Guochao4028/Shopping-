...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier cityArray:(NSArray*)array indexPath:(NSIndexPath *)indexPath
{
    ...
    if (self)
    {
        ...
        for(int i=0;i<array.count;i++)
        {
            ...
            btn.center = CGPointMake(66+(ScreenWidth/3-10)*(i%3), 30+(40+10)*(i/3));
            btn.tag = i;
            [btn setTitle:array[i] forState:(UIControlStateNormal)];
            btn.bounds = CGRectMake(0, 0, 104, 40);
