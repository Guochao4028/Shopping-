...
- (void)lgf_CenterPageChildVCLoadData:(UIViewController *_Nullable)VC selectIndex:(NSInteger)selectIndex loadType:(lgf_ChildLoadType)loadType;
// 配置内部 centerPageChildVC
- (void)lgf_CenterChildPageVCDidLoad:(UIViewController *_Nullable)VC;
// 返回 cell 个数
- (NSInteger)lgf_NumberOfItems:(UIViewController *_Nullable)VC;
// 返回 cell 大小
- (CGSize)lgf_SizeForItemAtIndexPath:(NSIndexPath *_Nullable)indexPath VC:(UIViewController *)VC;
// 返回 cellclass 用于注册cell 如果是xibcell 请建立与 cellclass 相同名字的 xib
- (Class _Nullable )lgf_CenterChildPageCVCellClass:(UIViewController *)centerPageChildVC;
// cell 数据源赋值
...
@property (weak, nonatomic) IBOutlet UICollectionView * _Nullable lgf_CenterChildPageCV;
// 用于控制联动的 空白ScrollView
@property (weak, nonatomic) IBOutlet UIScrollView * _Nullable lgf_PanScrollView;
// 外部分页滚动 UICollectionView
@property (strong, nonatomic) UICollectionView * _Nullable lgf_CenterPageCV;
@property (strong, nonatomic) NSMutableArray * _Nullable lgf_PageChildDataArray;
@property (strong, nonatomic) NSMutableArray * _Nullable lgf_PageChildDataHeightArray;
// 父控制器传进来的
@property (strong, nonatomic) UIView * _Nullable lgf_HeaderTapView;
@property (strong, nonatomic) UIView * _Nullable lgf_HeaderSuperView;
@property (strong, nonatomic) UIView * _Nullable LGFCenterPageView;
