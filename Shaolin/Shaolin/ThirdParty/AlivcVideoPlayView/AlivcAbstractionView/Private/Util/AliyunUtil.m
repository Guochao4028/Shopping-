...
//    UIImage *image = [self imageNamed:nameInBundle ofBundle:AliyunUtilImageBundleName];
    UIImage *image = [UIImage imageNamed:nameInBundle];
    return image;
...
//        int val = UIInterfaceOrientationLandscapeRight;
    ...
    int val = isFull ? UIInterfaceOrientationLandscapeRight:UIInterfaceOrientationPortrait;
    [[UIApplication sharedApplication]setStatusBarOrientation:val animated:YES];
}
...
+ (NSString *)timeformatFromSeconds:(NSInteger)seconds {
    ...
    if ([format_time isEqualToString:@"00:-42:-21"]) {
        return @"00:00:00";
    }
