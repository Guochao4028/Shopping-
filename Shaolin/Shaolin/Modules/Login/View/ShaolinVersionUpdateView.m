...
- (UIButton *)upgradeNowBtn{
    if (!_upgradeNowBtn){
        ...
        [_upgradeNowBtn setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
...
- (UIButton *)nextTimeBtn{
    if (!_nextTimeBtn){
        ...
        [_nextTimeBtn setBackgroundColor:KTextGray_F1];
        [_nextTimeBtn setTitleColor:KTextGray_999 forState:UIControlStateNormal];
