...
/**
 *  1.设置数据源
 *    单列：@[SLLocalizedString(@"男"), SLLocalizedString(@"女"), SLLocalizedString(@"其他")]，或直接传模型数组（NSArray <BRResultModel *>* dataSourceArr）
 *    多列：@[@[SLLocalizedString(@"语文"), SLLocalizedString(@"数学"), SLLocalizedString(@"英语")], @[SLLocalizedString(@"优秀"),SLLocalizedString( @"良好")]]，或直接传多维模型数组
 ...
 *
 *  @param title               选择器标题
 *  @param dataSourceArr       数据源（如：@[SLLocalizedString(@"男"), SLLocalizedString(@"女"), SLLocalizedString(@"其他")]，或直接传一维模型数组(NSArray <BRResultModel *>*）
 ...
 *
 *  @param title               选择器标题
 *  @param dataSourceArr       数据源（如：@[SLLocalizedString(@"男"), SLLocalizedString(@"女"), SLLocalizedString(@"其他")]，或直接传模型数组）
 *  @param selectIndex         默认选中的位置
 ...
 *
 *  @param title               选择器标题
 *  @param dataSourceArr       数据源（如：@[@[SLLocalizedString(@"语文"), SLLocalizedString(@"数学"), SLLocalizedString(@"英语")], @[SLLocalizedString(@"优秀"), SLLocalizedString(@"良好"), SLLocalizedString(@"及格")]]，或直接传多维模型数组）
