...
- (NSURLSessionDataTask *)lgf_GET:(NSString *)URLString
    ...
    return [self.lgf_SessionManager GET:url parameters:parameters headers:nil progress:nil success:success failure:failure];
}
...
- (NSURLSessionDataTask *)lgf_POST:(NSString *)URLString
    ...
    NSLog(@"请求的地址>>>>>>>>>>>>>>>>>%@", url);
    NSLog(@"请求的参数>>>>>>>>>>>>>>>>>%@", parameters);
    return [self.lgf_SessionManager POST:url parameters:parameters headers:nil progress:nil success:success failure:failure];
}
