...
- (void)requestData:(void (^)(NSArray *dataArray))success failure:(void (^)(NSString * _Nullable errorReason))failure{
    ...
    }else if ([self.statementType isEqualToString:SLLocalizedString(@"功德佛事")]){
        [params setObject:@"6" forKey:@"orderType"];
    }
...
- (UIButton *)selectTypeButton{
    ...
    if (_selectTypeButton == nil) {
        ...
        [_selectTypeButton setTitleColor:KTextGray_666 forState:UIControlStateNormal];
