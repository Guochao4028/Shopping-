...
//        self.bgImage.image = [UIImage imageNamed:@"login_input"];
        ...
        self.bgImage.layer.borderColor = [UIColor hexColor:@"dddddd"].CGColor;
        self.bgImage.layer.cornerRadius = 25;
        
        [self addSubview:self.bgImage];
        self.myTextField = [[UITextField alloc] init];
        self.myTextField.textColor = [UIColor colorForHex:@"333333"];
        ...
        self.myTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:placeholder attributes:@{NSForegroundColorAttributeName: [UIColor colorForHex:@"969696"]}];
