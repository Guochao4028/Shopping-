...
-(UITableView *)tabelView{
    ...
    if (_tabelView == nil) {
        ...
        [_tabelView registerNib:[UINib nibWithNibName:NSStringFromClass([OrderFillGoodsTableCell class])bundle:nil]
         forCellReuseIdentifier:kOrderFillGoodsTableCellIdentifier];
