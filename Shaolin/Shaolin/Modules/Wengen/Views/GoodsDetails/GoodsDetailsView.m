...
-(UIView*) tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    if (section == 2) {
        ...
        [horizontalLLine setBackgroundColor:KTextGray_DDD];
        ...
        [verticalLLine setBackgroundColor:KTextGray_DDD];
        ...
        [verticalRLine setBackgroundColor:KTextGray_DDD];
        ...
        [horizontalRLine setBackgroundColor:KTextGray_DDD];
