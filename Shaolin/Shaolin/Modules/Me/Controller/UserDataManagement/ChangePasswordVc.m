...
//        make.top.mas_equalTo(NavBar_Height+SLChange(40));
    ...
    v1.backgroundColor = KTextGray_EEE;
    ...
    UIView *v2 = [[UIView alloc]init];
       v2.backgroundColor = KTextGray_EEE;
    ...
    v3.backgroundColor = KTextGray_EEE;
...
//        [_leftBtn setTitleColor:KTextGray_12 forState:(UIControlStateNormal)];
...
- (UITextField *)oldTf
{
    if (!_oldTf) {
        _oldTf = [[UITextField alloc] init];
                ...
                _oldTf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请填写旧密码") attributes:@{NSForegroundColorAttributeName: KTextGray_B7}];
...
- (UITextField *)nowTf
{
    if (!_nowTf) {
        _nowTf = [[UITextField alloc] init];
                _nowTf.textColor = KTextGray_333;
...
//                _nowTf.keyboardType = UIKeyboardTypeDefault;
                ...
                _nowTf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请填写新密码") attributes:@{NSForegroundColorAttributeName: KTextGray_B7}];
...
- (UITextField *)nowTfTwo
{
    if (!_nowTfTwo) {
        _nowTfTwo = [[UITextField alloc] init];
                _nowTfTwo.textColor = KTextGray_333;
...
//                _nowTfTwo.keyboardType = UIKeyboardTypeDefault;
                ...
                _nowTfTwo.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请再次确认填写") attributes:@{NSForegroundColorAttributeName: KTextGray_B7}];
