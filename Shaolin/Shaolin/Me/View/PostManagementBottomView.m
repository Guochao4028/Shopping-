...
- (UIButton *)allBtn{
    if (!_allBtn) {
        ...
        [_allBtn setImage:[UIImage imageNamed:@"me_postmanagement_select"] forState:(UIControlStateSelected)];
        [_allBtn setTitle:SLLocalizedString(@"  全选") forState:UIControlStateNormal];
        [_allBtn setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
    }
    return _allBtn;
}
