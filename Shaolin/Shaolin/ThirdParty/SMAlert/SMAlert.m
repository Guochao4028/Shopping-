...
+ (void)showCustomView:(UIView*)view stroke:(BOOL)isStroke confirmButton:(SMButton*)confirmButton cancleButton:(SMButton*)cancleButton{
    [[SMAlert sharedView] showImage:nil content:nil stroke:isStroke customView:view confirmButton:confirmButton cancleButton:cancleButton];
}
...
- (void)showImage:(UIImage*)image content:(NSString*)content customView:(UIView*)customView confirmButton:(SMButton*)confirmButton cancleButton:(SMButton*)cancleButton{
    [self showImage:image content:content stroke:NO customView:customView confirmButton:confirmButton cancleButton:cancleButton];
}
...
- (void)showImage:(UIImage*)image content:(NSString*)content stroke:(BOOL)isStroke customView:(UIView*)customView confirmButton:(SMButton*)confirmButton cancleButton:(SMButton*)cancleButton {
    ...
    if (customView && isStroke == NO) {
        [self.controlView setupCustomView:customView confirmButton:confirmButton cancleButton:cancleButton];
    }else if(customView && isStroke == YES) {
        [self.controlView setupCustomView:customView stroke:isStroke confirmButton:confirmButton cancleButton:cancleButton];
    }else{
