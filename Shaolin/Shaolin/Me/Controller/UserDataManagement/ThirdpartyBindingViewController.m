...
- (void)setUpView{
    ...
    phoneLabel.text = SLLocalizedString(@"电话号");
    phoneLabel.textColor = [UIColor colorForHex:@"333333"];
...
- (void)createThirdpartyTypeListView{
    ...
    for (NSString *type in self.thirdpartyTypes){
        ...
        UIView *line = [self view:[UIColor colorForHex:@"E5E5E5"]];
...
- (UIView *)createSubThirdpartyBindingView:(UIView *)parentView type:(NSString *)type {
    ...
    [button setBackgroundImage:[UIImage imageNamed:@"switch_on"] forState:UIControlStateSelected];
...
- (UIView *)showAlertView:(NSString *)title successStr:(NSString *)successStr cancelStr:(NSString *)cancelStr success:(void (^)(void))success cancel:(void (^)(void))cancel{
    ...
    if (cancelStr){
        ...
        cancelButton.layer.borderColor = [UIColor colorForHex:@"979797"].CGColor;
        cancelButton.titleLabel.font = kRegular(15);
        [cancelButton setBackgroundColor:[UIColor clearColor]];
        [cancelButton setTitle:cancelStr forState:UIControlStateNormal];
        [cancelButton setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
...
- (UILabel *)loginTypeLabel{
    if (!_loginTypeLabel){
        ...
        _loginTypeLabel.textColor = [UIColor colorForHex:@"666666"];
...
- (UILabel *)thirdpartyBindingLabel{
    if (!_thirdpartyBindingLabel){
        ...
        _thirdpartyBindingLabel.textColor = [UIColor colorForHex:@"666666"];
...
- (UILabel *)phoneNumberLabel{
    if (!_phoneNumberLabel){
        ...
        _phoneNumberLabel.textColor = [UIColor colorForHex:@"333333"];
