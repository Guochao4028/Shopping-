...
-(UIButton *)timeChooseBtn {
    if (!_timeChooseBtn) {
        ...
        [_timeChooseBtn setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateNormal];
        [_timeChooseBtn setImage:[UIImage imageNamed:@"downArrow"] forState:UIControlStateNormal];
        
        [_timeChooseBtn setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateSelected];
