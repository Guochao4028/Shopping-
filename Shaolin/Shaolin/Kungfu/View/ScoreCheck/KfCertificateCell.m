...
/*
   int state = [cellModel.state intValue];
    ...
    if (state == 0) {
        ...
        self.finishedLabel.textColor = [UIColor hexColor:@"BE0B1F"];
        [self.cerGetBtn setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateNormal];
        self.cerGetBtn.userInteractionEnabled = YES;
...
//        self.finishedLabel.text = SLLocalizedString(@"等待发送实物证书");
        ...
        self.finishedLabel.textColor = [UIColor hexColor:@"999999"];
        [self.cerGetBtn setTitleColor:[UIColor hexColor:@"999999"] forState:UIControlStateNormal];
