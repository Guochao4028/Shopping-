...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text{
    ...
    if (string.length > 0) {
        ...
        [self.sendButton setBackgroundColor:kMainYellow];
    } else {
        self.sendButton.enabled = NO;
        [self.sendButton setBackgroundColor:kMainLightYellow];
    }
//    [self.sendButton setEnabled:textView.text.length > 0];
...
-(UIView *)inputViewContainer{
    if (!_inputViewContainer){
        ...
        line.backgroundColor = KTextGray_F3;
...
//        CGFloat x = (ScreenWidth - w) / 2;
        ...
        _chatText.backgroundColor = KTextGray_F3;
        _chatText.textColor = KTextGray_333;
        ...
        [_chatText setSt_placeHolderColor:KTextGray_999];
...
//        [_sendButton setBackgroundColor:[UIColor colorWithRed:(142/255.0) green:(43/255.0) blue:(37/255.0) alpha:0.6]];
        ...
        [_sendButton setBackgroundColor:kMainLightYellow];
