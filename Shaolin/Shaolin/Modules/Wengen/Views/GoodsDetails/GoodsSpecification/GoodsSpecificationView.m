...
//        NSString *namesStr= [self.namesArray componentsJoinedByString:@","];
        ...
        [dic setValue:str forKey:@"attr_s"];
...
-(void)determineAction{
    ...
    if (self.currentSpecificationModel) {
        [dic setValue:self.currentSpecificationModel.specificationId forKey:@"goods_attr_id"];
    }
    
    [dic setValue:self.carGoodsModel.cartid forKey:@"id"];
    ...
    if (attr.count > 0) {
        ...
        for (int i = 0 ; i < attr.count; i++) {
           ...
           if([dataModel isKindOfClass:[NSNull class]] == YES){
            ...
            NSArray *tmpArray = [GoodsAttrBasisModel mj_objectArrayWithKeyValuesArray:dataDic[@"value"]];
            ...
            NSString *titleStr = dataDic[@"attr"][@"name"];
...
//            buyCountViewY  = y;
        ...
        if (self.goods_attr_id == nil) {
            ...
            for (GoodsSpecificationModel *specificationModel in self.goodsStoreInfoModelArray) {
             ...
             NSArray  *array = [self.currentSpecificationModel.attr_value_id_str componentsSeparatedByString:@","];
...
- (void)setCurrentSpecificationModel:(GoodsSpecificationModel *)currentSpecificationModel{
    ...
    if ([self.model.is_discount boolValue]) {
...
//    }
    ...
    if (currentSpecificationModel.stock != nil && currentSpecificationModel.stock.length > 0) {
        ...
        //已销售数
        NSInteger hasStock = [currentSpecificationModel.has_number integerValue];
