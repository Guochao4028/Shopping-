...
- (YYLabel *)contentLabel {
    if (!_contentLabel) {
        ...
        _contentLabel.textColor = [UIColor hexColor:@"999999"];
...
- (void)addSeeMoreButtonWithContentStr:(NSString *)str {
    ...
    self.contentLabel.attributedText = [[NSAttributedString alloc] initWithString:str attributes:@{NSFontAttributeName : font16,NSForegroundColorAttributeName:[UIColor hexColor:@"999999"]}];
    ...
    [text addAttribute:NSForegroundColorAttributeName value:[UIColor hexColor:@"999999"] range:expandRange];
    [text addAttribute:NSForegroundColorAttributeName value:[UIColor hexColor:@"999999"] range:NSMakeRange(0, expandRange.location)];
