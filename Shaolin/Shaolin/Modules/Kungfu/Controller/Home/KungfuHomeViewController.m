...
//        cell.subjectList = self.hotClassList;
        self.tagViewHeight = cell.tagView.bottom;
...
//        line = (array.count + 1)/2;
        CGFloat height = KungfuHomeCompilationNewCell.cellSize.height * line + 10*line + 10;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    sectionHeader.sectionViewHandle = ^{
        ...
        if (section == 4) {
            [[SLAppInfoModel sharedInstance] postPageChangeNotification:KNotificationKungfuPageChange index:@"1" params:@{@"params":@"考试"}];
        }
