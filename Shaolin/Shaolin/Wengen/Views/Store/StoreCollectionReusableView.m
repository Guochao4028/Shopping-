...
-(void)tuijian{
    NSLog(@"%s", __func__);
    [self.menuView.tuijianButton setTitleColor:[UIColor colorForHex:@"BE0B1F"] forState:UIControlStateNormal];
    
    [self.menuView.xiaoliangButton setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
    
    [self.menuView.qiehuanButton setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
    
    [self.menuView.zhijianButton setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
    
    [self.menuView.jiageLabel setTextColor:[UIColor colorForHex:@"333333"]];
...
-(void)xiaoliang{
    NSLog(@"%s", __func__);
    [self.menuView.tuijianButton setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
    
    [self.menuView.xiaoliangButton setTitleColor:[UIColor colorForHex:@"BE0B1F"] forState:UIControlStateNormal];
...
-(void)jiage{
    ...
    [self.menuView.jiageLabel setTextColor:[UIColor colorForHex:@"BE0B1F"]];
...
-(void)zhijian{
    ...
    [self.menuView.zhijianButton setTitleColor:[UIColor colorForHex:@"BE0B1F"] forState:UIControlStateNormal];
