...
-(void)layoutView{
    ...
    UIView *view2 = [[UIView alloc]init];
       view2.backgroundColor = [UIColor colorForHex:@"E5E5E5"];
    ...
    UIView *view3 = [[UIView alloc]init];
       view3.backgroundColor = [UIColor colorForHex:@"E5E5E5"];
    ...
    view4.backgroundColor = [UIColor colorForHex:@"E5E5E5"];
    ...
    UIView *view5 = [[UIView alloc]init];
       view5.backgroundColor = [UIColor colorForHex:@"E5E5E5"];
    ...
    UIView *view6 = [[UIView alloc]init];
       view6.backgroundColor = [UIColor colorForHex:@"E5E5E5"];
...
-(UITextField *)phoneTf
{
    if (!_phoneTf) {
        _phoneTf = [[UITextField alloc] init];
                _phoneTf.textColor = [UIColor colorForHex:@"333333"];
                _phoneTf.secureTextEntry = NO;
                _phoneTf.keyboardType = UIKeyboardTypeNumberPad;
                if (@available(iOS 12.0, *)) {
                        _phoneTf.textContentType = UITextContentTypeOneTimeCode;
                }
                _phoneTf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请输入手机号") attributes:@{NSForegroundColorAttributeName: [UIColor colorForHex:@"B7B7B7"]}];
...
-(UITextField *)codeTf
{
    if (!_codeTf) {
        _codeTf = [[UITextField alloc] init];
                _codeTf.textColor = [UIColor colorForHex:@"333333"];
                _codeTf.secureTextEntry = NO;
                _codeTf.keyboardType = UIKeyboardTypeNumberPad;
                if (@available(iOS 12.0, *)) {
                        _codeTf.textContentType = UITextContentTypeOneTimeCode;
                }
                _codeTf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请输入验证码") attributes:@{NSForegroundColorAttributeName: [UIColor colorForHex:@"B7B7B7"]}];
...
-(void)tapVerBtnAction:(id)sender
{
    ...
    if (self.phoneTf.text.length != 11) {
        [ShaolinProgressHUD singleTextHud:SLLocalizedString(@"手机号长度不正确") view:self.view afterDelay:TipSeconds];
        return;
    }
...
-(UITextField *)passWordTf
{
    if (!_passWordTf) {
        _passWordTf = [[UITextField alloc] init];
                _passWordTf.textColor = [UIColor colorForHex:@"333333"];
...
//                _passWordTf.keyboardType = UIKeyboardTypeDefault;
                ...
                _passWordTf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请重设密码") attributes:@{NSForegroundColorAttributeName: [UIColor colorForHex:@"B7B7B7"]}];
...
-(void)doneAction {
    if (self.phoneTf.text.length != 11) {
        [ShaolinProgressHUD singleTextHud:SLLocalizedString(@"手机号不正确") view:self.view afterDelay:TipSeconds];
        return;
    }
    if (self.codeTf.text.length == 0) {
        [ShaolinProgressHUD singleTextHud:SLLocalizedString(@"验证码不能为空") view:self.view afterDelay:TipSeconds];
        return;
    }
    if (self.passWordTf.text.length == 0) {
        [ShaolinProgressHUD singleTextHud:SLLocalizedString(@"密码不能为空") view:self.view afterDelay:TipSeconds];
        return;
    }
