...
//    [self addPopBackLeftItem];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:SLLocalizedString(@"转发") style:UIBarButtonItemStylePlain target:self action:@selector(doneAction)];
    self.title = SLLocalizedString(@"转发消息");
