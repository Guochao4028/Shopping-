...
- (UILabel *)speedLabel{
    if (!_speedLabel) {
        ...
        _speedLabel.text = SLLocalizedString(@"倍速播放");
...
- (void)layoutSubviews{
    ...
    [_downLoadBtn setTitle:SLLocalizedString(@"下载") forState:UIControlStateNormal];
    ...
    [_airplayBtn setTitle:SLLocalizedString(@"投屏") forState:UIControlStateNormal];
    ...
    [_barrageBtn setTitle:SLLocalizedString(@"弹幕设置") forState:UIControlStateNormal];
...
- (void)showSpeedViewSelectedPushInAnimateWithPlaySpeed:(float)playSpeed{
    [UIView animateWithDuration:0.3 animations:^{
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:@"PlayerWillChangeSpeed" object:[NSNumber numberWithFloat:playSpeed]];
