...
@interface GoodsDetailsBannerTableCell ()<UIScrollViewDelegate, SDCycleScrollViewDelegate, XQCarouselDelegate>
...
-(XQCarousel *)carousel{
    if (_carousel == nil) {
        _carousel = [XQCarousel scrollViewFrame:CGRectMake(0, 0, ScreenWidth, ScreenWidth) imageStringGroup:nil];
...
-(UILabel *)pageLabel{
    if (_pageLabel == nil) {
        _pageLabel = [[UILabel alloc]initWithFrame:CGRectMake(ScreenWidth - 56, ScreenWidth - 22, 56, 22)];
        [_pageLabel setFont:kMediumFont(15)];
        [_pageLabel setTextColor:[UIColor whiteColor]];
        [_pageLabel setBackgroundColor:[UIColor colorWithWhite:0 alpha:0.1]];
