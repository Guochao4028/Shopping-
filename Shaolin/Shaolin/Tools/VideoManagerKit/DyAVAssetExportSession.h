...
@protocol DyAVAssetExportSessionDelegate;

@interface DyAVAssetExportSession : NSObject
@property (nonatomic, weak) id<DyAVAssetExportSessionDelegate> delegate;
...
@protocol DyAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(DyAVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
