...
- (NSDateFormatter *)dfYesterdayHM
{
    if (_dfYesterdayHM == nil) {
        _dfYesterdayHM = [self _getDateFormatterWithFormat:SLLocalizedString(@"昨天HH:mm")];
    }
...
- (NSDateFormatter *)dfBeforeDawnHM
{
    if (_dfBeforeDawnHM == nil) {
        _dfBeforeDawnHM = [self _getDateFormatterWithFormat:SLLocalizedString(@"凌晨hh:mm")];
    }
...
{
    if (_dfAAHM == nil) {
        _dfAAHM = [self _getDateFormatterWithFormat:SLLocalizedString(@"上午hh:mm")];
    }
...
{
    if (_dfPPHM == nil) {
        _dfPPHM = [self _getDateFormatterWithFormat:SLLocalizedString(@"下午hh:mm")];
    }
...
{
    if (_dfNightHM == nil) {
        _dfNightHM = [self _getDateFormatterWithFormat:SLLocalizedString(@"晚上hh:mm")];
    }
