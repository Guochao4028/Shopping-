...
- (void)setUI {
    ...
    [missionAttributed setAttributes:@{NSForegroundColorAttributeName:[UIColor colorForHex:@"333333"]} range:NSMakeRange(0, 2)];
...
//    self.inLabel.text = SLLocalizedString(@"简介");
    ...
    [missionAttributed2 setAttributes:@{NSForegroundColorAttributeName:[UIColor colorForHex:@"333333"]} range:NSMakeRange(0, 2)];
    [missionAttributed2 addAttribute:NSFontAttributeName value:kRegular(15) range:NSMakeRange(0, 2)];
    
    [missionAttributed2 setAttributes:@{NSForegroundColorAttributeName:[UIColor redColor]} range:NSMakeRange(2, 1)];
    [missionAttributed2 addAttribute:NSFontAttributeName value:kRegular(15) range:NSMakeRange(2, 1)];
    
    self.inLabel.attributedText = missionAttributed2;
//    self.inLabel.textColor = [UIColor colorForHex:@"333333"];
    ...
    [pushBtn setTitleColor:[UIColor colorForHex:@"FFFFFF"] forState:(UIControlStateNormal)];
    pushBtn.titleLabel.font = kMediumFont(15);
    pushBtn.layer.masksToBounds = YES;
    pushBtn.layer.cornerRadius = SLChange(25);
    pushBtn.backgroundColor = RGBA(142, 43, 37, 1);
...
-(UITextView *)textField
{
    if (!_textField) {
        ...
        _textField.textColor = [UIColor colorForHex:@"333333"];
        _textField.returnKeyType = UIReturnKeyDone;
        _textField.delegate = self;
        _textField.keyboardType = UIKeyboardTypeDefault;
        [_textField setPlaceholder:SLLocalizedString(@"给视频起个名字吧") placeholdColor:[UIColor colorForHex:@"999999"]];
...
-(UITextView *)introductionField
{
    if (!_introductionField) {
        ...
        [_introductionField setPlaceholder:SLLocalizedString(@"简单介绍下视频吧") placeholdColor:[UIColor colorForHex:@"999999"]];
        
        _introductionField.textColor = [UIColor colorForHex:@"333333"];
