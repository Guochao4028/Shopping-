...
- (UILabel *)descriptionLabel{
    if (!_descriptionLabel){
        ...
        _descriptionLabel.textColor = KTextGray_999;
...
- (UIButton *)collectButton{
    if (!_collectButton){
        ...
        [_collectButton setImage:[UIImage imageNamed:@"focus_normal"] forState:UIControlStateNormal];
        [_collectButton setImage:[UIImage imageNamed:@"focus_select_yellow"] forState:UIControlStateSelected];
//        [_collectButton setImageEdgeInsets:UIEdgeInsetsMake(4, 4, 4, 4)];
