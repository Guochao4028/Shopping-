...
- (void)awakeFromNib {
    ...
    [self modifiedButton:self.obligationChangeOrdersButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
    
    [self modifiedButton:self.obligationCheckInvoiceButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
    
    [self modifiedButton:self.obligationPayButton borderColor:[UIColor colorForHex:@"BE0B1F"] cornerRadius:15];
    
    [self modifiedButton:self.receivingCheckInvoiceButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
    
    [self modifiedButton:self.receivingCheckLogisticsButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
    
    [self modifiedButton:self.receivingConfirmCoodsButton borderColor:[UIColor colorForHex:@"BE0B1F"] cornerRadius:15];
    
    [self modifiedButton:self.cancelAgainBuyButton borderColor:[UIColor colorForHex:@"BE0B1F"] cornerRadius:15];
    
    [self modifiedButton:self.completeAfterSaleButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
    
    [self modifiedButton:self.completeCheckInvoiceButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
    
    [self modifiedButton:self.completeAgainBuyButton borderColor:[UIColor colorForHex:@"BE0B1F"] cornerRadius:15];
    
    
     [self modifiedButton:self.reviewStarButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
    
    [self modifiedButton:self.waitingSendGoodsCheckInvoiceButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
...
-(void)updateLayout:(OrderListModel *)listModel{
    ...
    if ([status isEqualToString:@"1"] == YES) {
        ...
        if ([listModel.evaluate_status isEqualToString:@"1"]) {
            if ([goodsModel.star isEqualToString:@"0"] || [goodsModel.star isEqualToString:@"0.0"]) {
                self.reviewStarLabel.text = SLLocalizedString(@"评价星级：5.0");
            } else {
                self.reviewStarLabel.text = [NSString stringWithFormat:SLLocalizedString(@"评价星级：%@"),NotNilAndNull(goodsModel.star)?goodsModel.star:SLLocalizedString(@"未知")];
            }
