...
-(void)setDataModel:(NSDictionary *)dataModel{
    ...
    [self.titleLabel setBackgroundColor:KTextGray_FA];
    ...
    if ([color boolValue]) {
        ...
        self.titleLabel.layer.backgroundColor = KTextGray_999.CGColor;
    }
...
-(void)setAddressModel:(EnrollmentAddressModel *)addressModel{
    ...
    [self.titleLabel setTextColor:KTextGray_999];
    self.titleLabel.layer.borderWidth = 0;
    self.titleLabel.layer.borderColor = KTextGray_999.CGColor;
