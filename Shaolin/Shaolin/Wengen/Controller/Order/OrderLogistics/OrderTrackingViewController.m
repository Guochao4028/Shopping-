...
- (UILabel *)titleNumberLabel {
    if (!_titleNumberLabel) {
        ...
        _titleNumberLabel.textColor = [UIColor colorForHex:@"333333"];
    }
...
- (UILabel *)numberLabel {
    if (!_numberLabel) {
        ...
        _numberLabel.textColor = [UIColor colorForHex:@"333333"];
    }
    return _numberLabel;
}
- (UIButton *)coPyButton {
    if (!_coPyButton) {
        ...
        [_coPyButton setTitleColor:[UIColor colorForHex:@"333333"] forState:(UIControlStateNormal)];
...
- (UILabel *)personLabel {
    if (!_personLabel) {
        ...
        _personLabel.textColor = [UIColor colorForHex:@"333333"];
    }
    return _personLabel;
}
- (UILabel *)personName {
    if (!_personName) {
        ...
        _personName.textColor = [UIColor colorForHex:@"333333"];
    }
    return _personName;
}
#pragma mark - 复制功能
