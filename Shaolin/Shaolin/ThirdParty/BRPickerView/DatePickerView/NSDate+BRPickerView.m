...
- (NSString *)br_weekdayString {
    switch (self.br_weekday - 1) {
        case 0:
        {
            return SLLocalizedString(@"周日");
        }
            break;
        case 1:
        {
            return SLLocalizedString(@"周一");
        }
            break;
        case 2:
        {
            return SLLocalizedString(@"周二");
        }
            break;
        case 3:
        {
            return SLLocalizedString(@"周三");
        }
            break;
        case 4:
        {
            return SLLocalizedString(@"周四");
        }
            break;
        case 5:
        {
            return SLLocalizedString(@"周五");
        }
            break;
        case 6:
        {
            return SLLocalizedString(@"周六");
        }
            break;
