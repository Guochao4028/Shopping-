...
- (UIButton *)playButton{
    if (!_playButton) {
        ...
        [_playButton setImage:[AliyunUtil imageWithNameInBundle:@"al_play_start"] forState:UIControlStateNormal];
        [_playButton setImage:[AliyunUtil imageWithNameInBundle:@"al_play_stop"] forState:UIControlStateSelected];
...
- (void)setSkin:(AliyunVodPlayerViewSkin)skin{
    ...
    [self.playButton setImage:[AliyunUtil imageWithNameInBundle:@"al_play_start" skin:skin] forState:UIControlStateNormal];
    [self.playButton setImage:[AliyunUtil imageWithNameInBundle:@"al_play_stop" skin:skin] forState:UIControlStateSelected];
...
- (NSString *)qualityFromTrackDefinition:(NSString *)definition {
    ...
    switch (index) {
        case 0:
            nameStr = [SLLocalizedString(@"流畅") localString];
            break;
        case 1:
            nameStr = [SLLocalizedString(@"超清") localString];
            break;
        case 2:
            nameStr = [SLLocalizedString(@"标清") localString];
            break;
        case 3:
            nameStr = [SLLocalizedString(@"原画") localString];
            break;
        case 4:
            nameStr = [SLLocalizedString(@"高清") localString];
            break;
        case 5:
        ...
        case 6:
            ...
            break;
        case 7:
            nameStr = [SLLocalizedString(@"低音质") localString];
            break;
        case 8:
            nameStr = [SLLocalizedString(@"高音质") localString];
            break;
        default:
            break;
    }
