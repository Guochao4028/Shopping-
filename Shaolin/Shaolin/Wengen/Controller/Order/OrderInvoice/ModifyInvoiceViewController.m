        ...
        @try {
            ...
            if (valueIsNil){
                ...
                if ([property.name isEqualToString:@"revice_phone"]) {
                    tipMsg = SLLocalizedString(@"请填写收票人电话");
                }
...
-(UIButton *)bottomButton{
    if (_bottomButton == nil) {
        ...
        [_bottomButton setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
        [_bottomButton.titleLabel setFont:kRegular(15)];
        _bottomButton.layer.borderWidth = 1;
        _bottomButton.layer.borderColor = [UIColor colorForHex:@"979797"].CGColor;
