...
- (void)setupView
{
    ...
    [self.titleLabe mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(self.bigImage.mas_left).mas_offset(-15);//-SLChange(15)
...
- (UIImageView *)imageOne
{
    if (!_imageOne) {
        ...
        _imageOne.contentMode = UIViewContentModeScaleAspectFill;
        
        CGRect bounds = CGRectMake(0, 0, 53, 68);
        UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:bounds byRoundingCorners:UIRectCornerBottomLeft | UIRectCornerTopLeft cornerRadii:CGSizeMake(4, 4)];
        CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
        maskLayer.frame = bounds;
        maskLayer.path = maskPath.CGPath;
        [_imageOne.layer addSublayer:maskLayer];
        _imageOne.layer.mask = maskLayer;
        _imageOne.layer.masksToBounds = YES;
        _imageOne.clipsToBounds = YES;
    }
    return _imageOne;
}
...
- (UIImageView *)imageTwo
{
    if (!_imageTwo) {
        ...
        _imageTwo.contentMode = UIViewContentModeScaleAspectFill;
        ...
        CGRect bounds = CGRectMake(0, 0, 53, 68);
        UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:bounds byRoundingCorners:UIRectCornerTopRight | UIRectCornerBottomRight cornerRadii:CGSizeMake(4, 4)];
        CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
        maskLayer.frame = bounds;
        maskLayer.path = maskPath.CGPath;
        [_imageTwo.layer addSublayer:maskLayer];
        _imageTwo.layer.mask = maskLayer;
        _imageTwo.layer.masksToBounds = YES;
        _imageTwo.clipsToBounds = YES;
    }
    return _imageTwo;
}
