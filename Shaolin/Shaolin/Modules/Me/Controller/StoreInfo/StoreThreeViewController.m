...
-(GCTextField *)storeTf
{
    if (!_storeTf) {
        ...
        [_storeTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
-(GCTextField *)contentTf
{
    if (!_contentTf) {
        ...
        [_contentTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
-(GCTextField *)addressTf
{
    if (!_addressTf) {
        ...
        [_addressTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextView *)textView {
    if (!_textView) {
        ...
        _textView.textColor = KTextGray_333;
