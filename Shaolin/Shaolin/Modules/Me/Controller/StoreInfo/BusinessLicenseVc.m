...
- (UITextField *)licenseTf
{
    if (!_licenseTf) {
        ...
        [_licenseTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)companyTf
{
    if (!_companyTf) {
        ...
        [_companyTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)licenseNumTf
{
    if (!_licenseNumTf) {
        ...
        [_licenseNumTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)licenseAddressTf
{
    if (!_licenseAddressTf) {
        ...
        [_licenseAddressTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)licenseDetailedAddress
{
    if (!_licenseDetailedAddress) {
        ...
        [_licenseDetailedAddress setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)createTf
{
    if (!_createTf) {
        ...
        [_createTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)startTf
{
    if (!_startTf) {
        ...
        [_startTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)endTf
{
    if (!_endTf) {
        ...
        [_endTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UIButton *)longTimeBtn {
    if (!_longTimeBtn) {
        ...
        [_longTimeBtn setTitleColor:KTextGray_333 forState:(UIControlStateNormal)];
...
- (UITextField *)capitalTf
{
    if (!_capitalTf) {
        ...
        [_capitalTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)scopeBusinessTf
{
    if (!_scopeBusinessTf) {
        ...
        [_scopeBusinessTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)companyAddressTf
{
    if (!_companyAddressTf) {
        ...
        [_companyAddressTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)companyDetailedAddressTf
{
    if (!_companyDetailedAddressTf) {
        ...
        [_companyDetailedAddressTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)companyPhone
{
    if (!_companyPhone) {
        ...
        [_companyPhone setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)emergencyPersonNameTf
{
    if (!_emergencyPersonNameTf) {
        ...
        _emergencyPersonNameTf.placeholder = SLLocalizedString(@"请填写姓名");
        _emergencyPersonNameTf.maxLimit = 40;
        _emergencyPersonNameTf.delegate = self;
        [_emergencyPersonNameTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UITextField *)emergencyPersonPhoneTf
{
    if (!_emergencyPersonPhoneTf) {
        ...
        [_emergencyPersonPhoneTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
