...
-(void)initUI{
    ...
    self.addCarButton.layer.cornerRadius = 40/2;
    self.buyButton.layer.cornerRadius = 40/2;
    
    [self.addCarButton.layer setBorderWidth:1];
    [self.addCarButton.layer setBorderColor:kMainYellow.CGColor];
...
-(void)setIsSingle:(BOOL)isSingle{
    if (isSingle) {
        ...
        self.determineButton.layer.cornerRadius = 40/2;
