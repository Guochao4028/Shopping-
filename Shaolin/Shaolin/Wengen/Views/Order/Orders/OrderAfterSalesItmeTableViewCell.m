...
- (void)awakeFromNib {
    ...
    [self modifiedButton: self.cancelButton borderColor:[UIColor colorForHex:@"979797"] cornerRadius:15];
...
-(void)setListModel:(OrderListModel *)listModel{
    ...
    if ([refund_status isEqualToString:@"1"]) {
        ...
        [self.jumpButton setTitleColor:[UIColor colorForHex:@"BE0B1F"] forState:UIControlStateNormal];
        ...
        [self modifiedButton:self.jumpButton borderColor:[UIColor colorForHex:@"BE0B1F"] cornerRadius:15];
        ...
        [self.jumpButton setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
        
        [self.instructionsLabel setText:goodsModel.remark];
        [self modifiedButton:self.jumpButton borderColor:[UIColor colorForHex:@"999999"] cornerRadius:15];
        self.jumpButtonW.constant = 90;
