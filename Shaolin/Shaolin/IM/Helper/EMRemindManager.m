...
- (void)_localNotification:(EMMessage *)message
    ...
    if (isNeed) {
        ...
        switch (messageBody.type) {
            ...
            {
                messageStr = SLLocalizedString(@"图片");
            }
                break;
            case EMMessageBodyTypeLocation:
            {
                messageStr = SLLocalizedString(@"位置");
            }
                break;
            case EMMessageBodyTypeVoice:
            {
                messageStr = SLLocalizedString(@"音频");
            }
                break;
            case EMMessageBodyTypeVideo:{
                messageStr = SLLocalizedString(@"视频");
            }
                break;
            case EMMessageBodyTypeFile:{
                messageStr = SLLocalizedString(@"文件");
            }
                break;
            default:
                break;
        ...
        alertBody = SLLocalizedString(@"您有一条新消息");
    }
    ...
    if (NSClassFromString(@"UNUserNotificationCenter")) {
        ...
        notification.alertAction = SLLocalizedString(@"打开");
