...
- (NSString *)cancelBtnTitle {
    if (!_cancelBtnTitle && !_cancelBtnImage) {
        _cancelBtnTitle = [NSBundle br_localizedStringForKey:SLLocalizedString(@"取消") language:self.language];
    }
...
- (NSString *)doneBtnTitle {
    if (!_doneBtnTitle && !_doneBtnImage) {
        _doneBtnTitle = [NSBundle br_localizedStringForKey:SLLocalizedString(@"确定") language:self.language];
    }
...
+ (instancetype)pickerStyleWithDoneTextColor:(UIColor *)doneTextColor {
    ...
    if (doneTextColor) {
        ...
        customStyle.doneBtnTitle = [NSBundle br_localizedStringForKey:SLLocalizedString(@"完成") language:customStyle.language];
    }
    return customStyle;
}
