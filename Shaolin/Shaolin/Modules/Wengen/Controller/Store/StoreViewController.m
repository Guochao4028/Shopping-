    ...
    if (sender.isSelected) {
        ...
        [[DataManager shareInstance]cancelCollect:@{@"club_id":self.storeId} Callback:^(Message *message) {
            ...
            if (message.isSuccess == YES) {
                ...
                [sender setBackgroundColor:kMainYellow];
                sender.layer.borderColor = kMainYellow.CGColor;
                sender.layer.borderWidth = 1;
                sender.layer.cornerRadius = 30/2;
                self.isCollect = NO;
            }
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.isGrid == YES) {
        ...
        CGFloat itemWidth = (ScreenWidth - 24 ) / 2;
//        CGFloat itemHeight = (itemWidth - 165) + 253;
      return CGSizeMake(itemWidth, 260 * WIDTHTPROPROTION);
    }else{
...
-(UICollectionView *)collectionView{
    ...
    if (_collectionView == nil) {
        ...
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - kBottomSafeHeight) collectionViewLayout:layout];
...
-(UILabel *)numberLabel{
    if (_numberLabel == nil) {
        ...
        _numberLabel  = [[UILabel alloc]initWithFrame:CGRectMake(x, y, 15, 15)];
        [_numberLabel setFont:kRegular(9)];
        [_numberLabel setTextColor:kMainYellow];
        [_numberLabel setTextAlignment:NSTextAlignmentCenter];
        _numberLabel.layer.cornerRadius = 15/2;
        _numberLabel.layer.borderColor =kMainYellow.CGColor;
