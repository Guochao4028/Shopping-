...
//        [string addAttributes:@{NSForegroundColorAttributeName: UIColor.whiteColor} range:NSMakeRange(0, 11)];
        
        [string addAttributes:@{NSFontAttributeName: kBoldFont(17), NSForegroundColorAttributeName: [UIColor hexColor:@"BE0B1F"]} range:NSMakeRange(12, self.kungfuLevel.length)];
...
//        self.examLabel.text = [NSString stringWithFormat:SLLocalizedString(@"您已考的位阶已超过全球%@的学员"),self.kungfuLevel];
