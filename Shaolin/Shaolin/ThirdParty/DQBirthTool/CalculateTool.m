...
+ (NSString *)calculateConstellationWithMonth:(NSInteger)month day:(NSInteger)day{
    NSString *astroString = SLLocalizedString(@"魔羯水瓶双鱼白羊金牛双子巨蟹狮子处女天秤天蝎射手魔羯");
    NSString *astroFormat = @"102123444543";
    NSString *result;
    
    if (month<1 || month>12 || day<1 || day>31){
        return SLLocalizedString(@"错误日期格式!");
    }
    ...
    return [NSString stringWithFormat:SLLocalizedString(@"%@座"),result];
}
