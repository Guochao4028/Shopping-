...
- (void)initUI{
    ...
    [self modifiedButton:self.numberButton borderColor:kMainYellow cornerRadius:15];
    
    [self modifiedButton:self.oneViewApplyCancelButton borderColor:kMainYellow cornerRadius:15];
