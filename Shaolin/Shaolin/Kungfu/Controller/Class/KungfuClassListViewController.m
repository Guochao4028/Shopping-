...
//        self.typeSortBtn.top = self.searchView.bottom;
    ...
    self.typeTable.frame = CGRectMake(self.typeSortBtn.left, self.typeSortBtn.bottom - 2, self.typeSortBtn.width, 0);
...
- (void) hideTypeTable {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        self.typeTable.frame = CGRectMake(self.typeTable.left, self.typeSortBtn.bottom + 2, self.typeTable.width, 0);
    }];
}
