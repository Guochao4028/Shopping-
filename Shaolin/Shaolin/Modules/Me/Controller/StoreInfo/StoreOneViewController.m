...
-(UITextField *)personNameTf
{
    if (!_personNameTf) {
        ...
        _personNameTf.placeholder = SLLocalizedString(@"请填写姓名");
        
        _personNameTf.delegate = self;
        _personNameTf.keyboardType = UIKeyboardTypeDefault;
        [_personNameTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
-(UITextField *)personEmailTf {
    if (!_personEmailTf) {
        ...
        [_personEmailTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
- (UIButton *)licenceBtn {
    if (!_licenceBtn) {
        ...
        [_licenceBtn setTitleColor:KTextGray_999 forState:(UIControlStateNormal)];
...
- (UIButton *)personBtn {
    if (!_personBtn) {
        ...
        [_personBtn setTitleColor:KTextGray_999 forState:(UIControlStateNormal)];
...
- (UIButton *)organizationBtn {
    if (!_organizationBtn) {
        ...
        [_organizationBtn setTitleColor:KTextGray_999 forState:(UIControlStateNormal)];
...
- (UIButton *)taxBtn {
    if (!_taxBtn) {
        ...
        [_taxBtn setTitleColor:KTextGray_999 forState:(UIControlStateNormal)];
...
- (void)nextAction {
    if (self.personNameTf.text.length == 0) {
        [ShaolinProgressHUD singleTextHud:SLLocalizedString(@"请填写姓名") view:self.view afterDelay:TipSeconds];
        return;
    }
