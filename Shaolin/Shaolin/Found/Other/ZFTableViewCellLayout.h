...
@property(nonatomic,readonly) CGRect praiseRect;
@property(nonatomic,readonly) CGRect shareRect;
@property (nonatomic,readonly) CGRect collectionRect;
@property (nonatomic,readonly) CGRect abstractsRect;
