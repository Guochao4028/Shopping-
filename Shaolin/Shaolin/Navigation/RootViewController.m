...
//        [self hideNavigationBarShadow];
    ...
    if (self.navigationBarStyle == NavigationBarRedTintColorStyle){
...
- (void)setNavigationBarClearTintColorBlackStyle{
    ...
    [self.leftBtn setTitleColor:[UIColor colorForHex:@"333333"] forState:UIControlStateNormal];
...
- (void)setNavigationBarRedTintColor {
    self.titleLabe.textColor = [UIColor whiteColor];
    [self.leftBtn setImage:[UIImage imageNamed:@"real_left"] forState:UIControlStateNormal];
    [self.leftBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.rightBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
- (UILabel *)titleLabe{
    if (!_titleLabe){
        ...
        _titleLabe.textColor = [UIColor colorForHex:@"333333"];
    }
    return _titleLabe;
}
...
- (UIButton *)rightBtn{
    if (!_rightBtn){
        _rightBtn = [[UIButton alloc]initWithFrame:CGRectMake(-16, 0, 35, 20)];
