...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo{
    if (error) {
//        [MBProgressHUD showErrorWithText:SLLocalizedString(@"保存失败")];
    } else {
//        [MBProgressHUD showSuccessWithText:SLLocalizedString(@"保存成功")];
    }
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    if ([self.title isEqualToString:SLLocalizedString(@"图片预览")]) {
...
//            UIAlertController *alertAction = [UIAlertController alertControllerWithTitle:SLLocalizedString(@"保存图片") message:nil preferredStyle:UIAlertControllerStyleActionSheet];
//            [alertAction addAction:[UIAlertAction actionWithTitle:SLLocalizedString(@"保存到相册") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
//                UIImageWriteToSavedPhotosAlbum(cell.imageView.image, weakSelf,
//                                               @selector(image:didFinishSavingWithError:contextInfo:), nil);
//            }]];
//
//            [alertAction addAction:[UIAlertAction actionWithTitle:SLLocalizedString(@"取消") style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
//                NSLog(@"取消", nil));
//            }]];
