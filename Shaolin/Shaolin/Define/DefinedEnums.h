...
typedef NS_ENUM(NSUInteger, KungfuApplyExpenseType){
    ...
    ///考试费(食宿)
    KungfuApplyExpenseExaminationBoardType = 2,
    /// 未选则任何选项
...
//订单详情 类型
typedef NS_ENUM(NSUInteger, MoneyStringFormattingType){
    ///钱符号缩小
    MoneyStringFormattingMoneyCoincidenceType = 20,
    ///整个价格 格式化 ￥0.00 钱符号缩小 小数点缩小
    MoneyStringFormattingMoneyAllFormattingType = 10,
};
