...
-(void)initUI{
    ...
    self.addCartButton.layer.cornerRadius = 32/2;
    self.nowBuyButton.layer.cornerRadius = 32/2;
    
    [self.addCartButton.layer setBorderWidth:1];
    [self.addCartButton.layer setBorderColor:kMainYellow.CGColor];
    ...
    if (carNumber > 0) {
        ...
        self.numberLabel.layer.cornerRadius = 11.5/2;
        self.numberLabel.layer.borderWidth = 1;
        self.numberLabel.layer.borderColor = kMainYellow.CGColor;
