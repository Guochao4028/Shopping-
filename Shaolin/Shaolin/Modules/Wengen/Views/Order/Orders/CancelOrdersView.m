...
-(UIView *)titleView{
    if (_titleView == nil) {
        ...
        [promptLabel setTextColor:KTextGray_333];
...
-(UIButton *)determineButton{
    ...
    if (_determineButton == nil) {
        ...
        CGFloat width =250;//CGRectGetWidth(self.contentView.bounds) - 32;
        CGFloat x =(CGRectGetWidth(self.contentView.bounds) - 250)/2;
        [_determineButton setFrame:CGRectMake(x, y, width, 40)];
