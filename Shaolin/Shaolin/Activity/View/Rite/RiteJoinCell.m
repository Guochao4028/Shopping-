...
-(void)layoutSubviews {
    ...
    [self.leftFirstLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(self.leftImgv.mas_left).offset(-5);
    }];
    
    [self.leftSecondLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.top.bottom.mas_equalTo(self.leftView);
...
-(UILabel *)leftFirstLabel {
    if (!_leftFirstLabel) {
        ...
        _leftFirstLabel.textAlignment = NSTextAlignmentCenter;
    }
...
-(UILabel *)rightFirstLabel {
    if (!_rightFirstLabel) {
        ...
        _rightFirstLabel.textAlignment = NSTextAlignmentCenter;
    }
...
-(UILabel *)rightSecondLabel {
    if (!_rightSecondLabel) {
        ...
        _rightSecondLabel.textAlignment = NSTextAlignmentCenter;
    }
