...
@property (weak, nonatomic) IBOutlet UIView *strictSelectionView;
...
//     [self initUI];
    ...
    [self.strictSelectionView setBackgroundColor:[UIColor colorForHex:@"f7f7f7"]];
    [self.recommendedView setBackgroundColor:[UIColor colorForHex:@"f7f7f7"]];

    UITapGestureRecognizer *strictSelectionTap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(strictSelectionAction)];
    [self.strictSelectionView addGestureRecognizer:strictSelectionTap];
    
    UITapGestureRecognizer *recommendedTap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(recommendedAction)];
    [self.recommendedView addGestureRecognizer:recommendedTap];
}
