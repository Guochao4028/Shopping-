...
- (void)layoutView
{
    ...
    lineView.backgroundColor = KTextGray_E5;
    ...
    UILabel *codeLabel = [[UILabel alloc]initWithFrame:CGRectMake(SLChange(16), SLChange(130), SLChange(80), 24)];
         ...
         codeLabel.textColor = KTextGray_333;
...
- (UITextField *)phoneTf {
    if (!_phoneTf) {
        ...
        [_phoneTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
...
//           _codeTf.keyboardType = UIKeyboardTypeNumberPad;
           ...
           [_codeTf setValue:KTextGray_999 forKeyPath:@"placeholderLabel.textColor"];
