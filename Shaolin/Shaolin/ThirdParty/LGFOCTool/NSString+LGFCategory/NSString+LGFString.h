...
/**
 ...
 @return 发布距离当前时间的字符串:SLLocalizedString(@"1年前") SLLocalizedString(@"1个月前") SLLocalizedString(@"1周前") SLLocalizedString(@"1天前") SLLocalizedString(@"1小时前") SLLocalizedString(@"1分钟前") SLLocalizedString(@"刚刚")
 */
