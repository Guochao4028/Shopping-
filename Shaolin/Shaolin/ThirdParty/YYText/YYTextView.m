...
- (NSArray *)_localizedUndoStrings {
    ...
    dispatch_once(&onceToken, ^{
        NSDictionary *dic = @{
            ...
            @"ja" : @[ @"キャンセル", SLLocalizedString(@"やり直す"), SLLocalizedString(@"やり直す - 入力"), SLLocalizedString(@"取り消す"), SLLocalizedString(@"取り消す - 入力") ],
            ...
            @"zh" : @[ SLLocalizedString(@"取消"), SLLocalizedString(@"重做"), SLLocalizedString(@"重做键入"), SLLocalizedString(@"撤销"), SLLocalizedString(@"撤销键入") ],
            @"zh_CN" : @[ SLLocalizedString(@"取消"), SLLocalizedString(@"重做"), SLLocalizedString(@"重做键入"), SLLocalizedString(@"撤销"), SLLocalizedString(@"撤销键入") ],
            @"zh_HK" : @[ SLLocalizedString(@"取消"), SLLocalizedString(@"重做"), SLLocalizedString(@"重做輸入"), SLLocalizedString(@"還原"), SLLocalizedString(@"還原輸入") ],
            @"zh_TW" : @[ SLLocalizedString(@"取消"), SLLocalizedString(@"重做"), SLLocalizedString(@"重做輸入"), SLLocalizedString(@"還原"), SLLocalizedString(@"還原輸入") ]
        };
