...
//            birth = [birth componentsSeparatedByString:@" "].firstObject;
            ...
            if (type == 1) {
                ...
                [self.birthBtn setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateNormal];
            }
...
//        [cell.contentView addSubview:self.changeTypeIcon];
    ...
    else if ([title isEqualToString:SLLocalizedString(@"出生日期")])
    {
        ...
        if ([self.birthBtn.titleLabel.text isEqualToString:SLLocalizedString(@"请选择出生日期")]) {
            [self.birthBtn setTitleColor:[UIColor hexColor:@"B7B7B7"] forState:UIControlStateNormal];
        } else {
            [self.birthBtn setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateNormal];
        }
    }
...
-(UITextField *)nameTf
{
    if (!_nameTf) {
        ...
        _nameTf.textColor = [UIColor colorForHex:@"333333"];
        _nameTf.returnKeyType = UIReturnKeyDone;
        _nameTf.keyboardType = UIKeyboardTypeDefault;
        if (@available(iOS 12.0, *)) {
            _nameTf.textContentType = UITextContentTypeOneTimeCode;
        }
        _nameTf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请填写姓名") attributes:@{NSForegroundColorAttributeName: [UIColor colorForHex:@"B7B7B7"]}];
...
-(UITextField *)cardNumber
{
    if (!_cardNumber) {
        ...
        _cardNumber.textColor = [UIColor colorForHex:@"333333"];
        ...
        _cardNumber.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请填写身份证号码") attributes:@{NSForegroundColorAttributeName: [UIColor colorForHex:@"B7B7B7"]}];
...
-(UIButton *)changeTypeIcon {
    if (!_changeTypeIcon) {
        ...
        [_changeTypeIcon setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateNormal];
...
-(UITextField *)dressTf
{
    if (!_dressTf) {
        ...
        _dressTf.textColor = [UIColor colorForHex:@"333333"];
        ...
        _dressTf.attributedPlaceholder = [[NSAttributedString alloc] initWithString:SLLocalizedString(@"请填写你的户籍所在地") attributes:@{NSForegroundColorAttributeName: [UIColor colorForHex:@"B7B7B7"]}];
...
-(UIButton *)manBtn
{
    if (!_manBtn) {
        ...
        _manBtn.tag =101;
        [_manBtn setTitleColor:[UIColor colorForHex:@"333333"] forState:(UIControlStateNormal)];
...
-(UIButton *)womanBtn
{
    if (!_womanBtn) {
        ...
        _womanBtn.tag =102;
        [_womanBtn setTitleColor:[UIColor colorForHex:@"333333"] forState:(UIControlStateNormal)];
...
//        [_birthBtn setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateNormal];
        [_birthBtn setTitleColor:[UIColor hexColor:@"B7B7B7"] forState:UIControlStateNormal];
...
-(SLDatePickerView *)birthPickerView {
    ...
    if (!_birthPickerView) {
        ...
        _birthPickerView.resultBlock = ^(NSDate *selectDate, NSString *selectValue) {
            ...
            [weakSelf.birthBtn setTitleColor:[UIColor hexColor:@"333333"] forState:UIControlStateNormal];
        };
    }
